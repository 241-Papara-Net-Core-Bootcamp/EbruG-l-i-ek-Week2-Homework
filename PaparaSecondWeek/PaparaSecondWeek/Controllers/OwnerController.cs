...
namespace PaparaSecondWeek.Controllers
{
    ...
    public class OwnerController : ControllerBase
    {
        ...
        //Hata alacak bir endpoint yazildi.
        [HttpGet("SpecificOwner")]
        public IActionResult GetSpesificOwner()
        {
            Owner owner = new Owner();
            owner.Name = "Ebru";
            owner.Color = ColorEnum.Blue;
            owner.Description = "homework";
            
            if (owner.Name == "Ebrus")
            {
                return Ok("This is correct owner");
            }
